...
const INTERVIEW_TYPES: { type: InterviewType; icon: React.ElementType; label: string; desc: string; color: string }[] = [
  ...
  { type: "Mixed", icon: Shuffle, label: "Mixed", desc: "Balanced technical + behavioral", color: "#10b981" },
];
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} whileHover={{ y: -2 }}>
          <Card className="border-0 border-t-4 border-t-primary shadow-[0_4px_24px_rgba(124,58,237,0.10)] rounded-2xl bg-white cursor-pointer group" onClick={() => setInterviewDrawerOpen(true)}>
            <CardContent className="p-5">
              ...
              <p className="text-[14px] font-medium text-[#6b7280]">Real-time AI recruiter · Per-answer feedback · Scorecard</p>
            </CardContent>
          </Card>
        </motion.div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
            <Card className="border-0 shadow-sm rounded-2xl bg-[#f3f4f6] relative overflow-hidden h-36 opacity-60">
              <div className="absolute top-3 right-3 bg-[#ec4899] text-white text-[10px] font-bold px-2 py-0.5 rounded-full z-10">PRO</div>
              ...
              <div className="p-6 pb-8">
                ...
                {interviewDrawerOpen && (
                  <div className="space-y-5">
                    <div>
                      ...
                      <p className="text-[#6b7280] text-sm font-medium">Configure your mock placement interview</p>
                    </div>
                        ...
                        {INTERVIEW_TYPES.map(({ type, icon: Icon, label, desc, color }) => (
                          ...
                          >
                            <Icon
                              ...
                              style={{ color: interviewType === type ? color : "#9ca3af" }}
                            />
                          ...
                          <button
                            ...
                            className={cn(
                              ...
                              difficulty === d
                                ...
                                : "bg-white text-[#6b7280] hover:bg-[#f5f3ff]"
                            )}
                          >
                            {d === "Challenging" ? "🔥 " : ""}
                            {d}
                ...
                {testDrawerOpen && (
                  <div className="space-y-4">
                    ...
                    <p className="text-[#6b7280] font-medium text-[15px]">This is a 20-minute timed MCQ test covering aptitude and logic. You cannot pause once started.</p>
                    <motion.div whileTap={{ scale: 0.97 }}>
                      <Button
